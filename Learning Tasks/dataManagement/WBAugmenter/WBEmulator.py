...
import pickle
from dataManagement.WBAugmenter import imresize as resize


class WBEmulator:
  def __init__(self):
    # training encoded features
    self.features = np.load('dataManagement/params/features.npy')
    # mapping functions to emulate WB effects
    self.mappingFuncs = np.load('dataManagement/params/mappingFuncs.npy')
    # weight matrix for histogram encoding
    self.encoderWeights = np.load('dataManagement/params/encoderWeights.npy')
    # bias vector for histogram encoding
    self.encoderBias = np.load('dataManagement/params/encoderBias.npy')
