...
peak_l = metric_par.csf_sr(1);
low_s = metric_par.csf_sr(2);
low_exp = metric_par.csf_sr(3);
high_s = metric_par.csf_sr(4);
high_exp = metric_par.csf_sr(5);
rod_sens = metric_par.csf_sr(6);
